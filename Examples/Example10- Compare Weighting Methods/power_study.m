...
[w,~,~,q_thresh] = bayes_weights(mu,sigma,pcer);
%q_thresh  is 0.12;
...
a = {'-','--',':','-.'};
figure, hold on
h = plot(global_array, power_unw,'linewidth',2); set(h,'LineStyle',a{1});
h = plot(global_array, power_reg,'linewidth',2); set(h,'LineStyle',a{2});
